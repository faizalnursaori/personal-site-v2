...
export const Hero = () => {
  ...
  return (
    <main className="flex flex-col items-center justify-center text-center min-h-screen space-y-16 mt-16">
      <div className="flex items-center py-2 px-4 rounded-full border border-blue-700 gap-2 text-sm text-blue-700">
      ...
      <div>
        ...
        <button
          ...
          className="mt-4 px-6 py-3 text-white font-bold text-lg bg-black rounded-xl border-2 border-blue-500 animate-pulse-border"
        >
          Appreciate Me
        </button>
      </div>

      <div className="mt-6 mx-auto lg:w-[75%]">
        <FeaturedProjects />
      </div>
    </main>
  );
