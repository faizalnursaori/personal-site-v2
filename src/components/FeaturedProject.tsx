  ...
  return (
    <>
      <section className="py-12 px-6">
        <h2 className="text-[26px] lg:text-[42px] font-bold text-center mb-8">Featured Projects</h2>
          ...
          {projects.map((project, index) => (
            <div key={index} className="rounded-xl overflow-hidden ">
              <Link href={project.link}>
                ...
                <div className="p-4">
                  <h3 className="text-base md:text-lg lg:text-2xl font-semibold text-gray-900 text-left">
                    {project.title}
                  </h3>
